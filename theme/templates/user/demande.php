...
if (!isset($_SESSION['id']) || $_SESSION['role'] != 'citoyen') {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            ...
                            if (in_array(strtolower($file_ext), $allowed)) {
                                ...
                                if (move_uploaded_file($file_tmp, $file_destination)) {
                                    ...
                                    if ($stmt->execute()) {
                                        ...
                                        $code_demande = $code; // AJOUTÉ - pour l'afficher dans la notification
                                    } else {
        ...
        //je dois mettre la redirection dans le script et l'adapter 
    }
?>
    ...
    <body>
        ...
        <?php if (isset($success) && $success === 'success') { ?>
            <div class="success-notification" id="notification">
                ...
                <h5>Demande soumise avec succès !</h5>
                <p>Code de suivi : <strong><?= $code_demande ?></strong></p>
                <p class="mb-3">Votre demande a bien été enregistrée.</p>
                <a href="suivi_demandes.php" class="btn btn-light btn-sm">
                    <i class="fa-solid fa-eye"></i> Voir le statut de ma demande
                </a>
            </div>
        <?php } ?>
