...
if (!isset($_SESSION['id']) && !isset($_SESSION['role'])) {
    ...
    //total des demandes avec les interesses
    $req = 'SELECT * FROM demandes d JOIN users u ON d.id_citoyen=u.id_user ORDER BY date ASC';
    $stt = $conn->prepare($req);
    $stt->execute();
    $demandes = $stt->fetchAll(PDO::FETCH_ASSOC);

    //Nbre de demande par types
    ...
    <body>
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="demande_attente.php" class="active">
                                        ...
                                        foreach ($demandes as $demande) {
                                            if ($demande['statut'] === 'en attente') { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class='btn btn-sm btn-primary' href='traitement.php?id_demande=<?= $demande['id_demande'] ?>&id_citoyen=<?= $demande['id_user'] ?>'>
