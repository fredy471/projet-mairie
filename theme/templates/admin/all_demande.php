...
if (!isset($_SESSION['id']) && !isset($_SESSION['role'])) {
    ...
    //total des demandes
    $sql = "SELECT u.nom AS agent_nom, u.prenom AS agent_prenom , code_demande, types, date, statut
            FROM demandes d JOIN users u ON d.id_agent = u.id_user ORDER BY date DESC";
